...
if __name__ == "__main__":
    ...
    parser.add_argument("--download-location", type=str, default="./data/downloaded", help="Location to save downloaded files")
    parser.add_argument("--output-location", type=str, default="./data/processed", help="Location to output processed markdown files")
