...
def download_meeting_files(start_year: int, start_month: int, end_year: int, end_month: int, meeting_filter: List[str] = None, file_filter: List[str] = None, download_location: str = "./data/meetings/downloaded", log_file_folder: str = ".logs"):
    ...
    downloader = MeetingFilesDownloader(destination_folder = download_location, log_file_folder=log_file_folder, log_file_name=f"{script_start_time.strftime('%Y-%m-%d_%H-%M-%S')}_failed_downloads.txt")
